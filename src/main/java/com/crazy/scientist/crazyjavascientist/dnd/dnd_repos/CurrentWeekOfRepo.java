...
@Repository
public interface CurrentWeekOfRepo
  extends JpaRepository<CurrentWeekOfEntity, Long> {
  @Transactional
  @Modifying
  @Query(
    "update CurrentWeekOfEntity current_week set current_week.current_week = :current_week_value where current_week.id=1"
  )

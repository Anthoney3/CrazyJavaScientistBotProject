...
public class DBTablePrinter {
     ...
     */
    public static String printTable(Connection conn,String query, String tableName){
      return  printTable(conn, tableName, query, DEFAULT_MAX_ROWS, DEFAULT_MAX_TEXT_COL_WIDTH);
    }
     ...
     */
    public static String printTable(Connection conn, String tableName,String query, int maxRows) {
        return printTable(conn, tableName, query, maxRows, DEFAULT_MAX_TEXT_COL_WIDTH);
    }
     ...
     */
    public static String printTable(Connection conn, String tableName, String query, int maxRows, int maxStringColWidth) {
        if (conn == null) {
        ...
        try {
           ...
           return printResultSet(rs, maxStringColWidth);
        ...
        try {
            ...
            for (int i = 0; i < rowCount; i++) {
                for (Column c : columns) {
                    ...
                    completedString.append(String.format(format, c.getValue(i)));
                    System.out.print(
                ...
                completedString.append("|");
                completedString.append("\n");
                completedString.append(rowSeparator);
                System.out.println("|");
